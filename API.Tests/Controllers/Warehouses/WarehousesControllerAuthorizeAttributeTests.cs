...
/// <summary>
/// WarehousesController yetkilendirme attribute'ları (reflection).
...
/// </summary>
public class WarehousesControllerAuthorizeAttributeTests
{
    ...
    {
        var authorize = typeof(WarehousesController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
    ...
    [Theory]
    [InlineData(nameof(WarehousesController.GetAll))]
    [InlineData(nameof(WarehousesController.GetById))]
    [InlineData(nameof(WarehousesController.GetByCompany))]
    public void ReadActions_AuthorizeRolesAll(string methodName)
    {
        var method = typeof(WarehousesController).GetMethod(methodName);
    ...
    {
        var method = typeof(WarehousesController).GetMethod(nameof(WarehousesController.Create));
        method.Should().NotBeNull();
    ...
    {
        var method = typeof(WarehousesController).GetMethod(nameof(WarehousesController.Update));
        method.Should().NotBeNull();
    ...
    [InlineData(nameof(WarehousesController.GetById))]
    [InlineData(nameof(WarehousesController.GetByCompany))]
    [InlineData(nameof(WarehousesController.Create))]
    [InlineData(nameof(WarehousesController.Update))]
    [InlineData(nameof(WarehousesController.Delete))]
