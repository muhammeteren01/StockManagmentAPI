...
/// <summary>
/// SuppliersController yetkilendirme attribute'ları (reflection).
...
/// </summary>
public class SuppliersControllerAuthorizeAttributeTests
{
    ...
    {
        var authorize = typeof(SuppliersController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
    ...
    [Theory]
    [InlineData(nameof(SuppliersController.GetAll))]
    [InlineData(nameof(SuppliersController.GetById))]
    [InlineData(nameof(SuppliersController.GetByCompany))]
    ...
    {
        var method = typeof(SuppliersController).GetMethod(nameof(SuppliersController.Create));
        method.Should().NotBeNull();
    ...
    {
        var method = typeof(SuppliersController).GetMethod(nameof(SuppliersController.Update));
        method.Should().NotBeNull();
    ...
    [InlineData(nameof(SuppliersController.GetById))]
    [InlineData(nameof(SuppliersController.GetByCompany))]
    [InlineData(nameof(SuppliersController.Create))]
    [InlineData(nameof(SuppliersController.Update))]
    [InlineData(nameof(SuppliersController.Delete))]
