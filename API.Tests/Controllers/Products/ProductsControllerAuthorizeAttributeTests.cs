...
/// <summary>
/// ProductsController yetkilendirme attribute'ları (reflection).
...
/// </summary>
public class ProductsControllerAuthorizeAttributeTests
{
    ...
    {
        var authorize = typeof(ProductsController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
    ...
    [Theory]
    [InlineData(nameof(ProductsController.GetAll))]
    [InlineData(nameof(ProductsController.GetById))]
    [InlineData(nameof(ProductsController.GetByCompany))]
