...
/// <summary>ProductsController.Delete birim testleri.</summary>
public class ProductsControllerDeleteTests
{
    ...
    public async Task Delete_WhenServiceSucceeds_ReturnsNoContent()
    {
        ...
        _productService.Verify(s => s.DeleteAsync(id, It.IsAny<CancellationToken>()), Times.Once);
    }

    /// <summary>
    /// Delete: ürün yok → KeyNotFoundException iletilir.
    /// </summary>
    [Fact]
