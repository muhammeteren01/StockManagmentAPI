...
/// <summary>
/// StockTransfersController yetkilendirme attribute'ları (reflection).
...
/// </summary>
public class StockTransfersControllerAuthorizeAttributeTests
{
    ...
    {
        var authorize = typeof(StockTransfersController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
    ...
    [Theory]
    [InlineData(nameof(StockTransfersController.GetAll))]
    [InlineData(nameof(StockTransfersController.GetById))]
    public void ReadActions_AuthorizeRolesAll(string methodName)
    {
        var method = typeof(StockTransfersController).GetMethod(methodName);
    ...
    {
        var method = typeof(StockTransfersController).GetMethod(nameof(StockTransfersController.Create));
        method.Should().NotBeNull();
    ...
    /// <summary>Start / Complete / Cancel: Writers; Staff hariç.</summary>
    [Theory]
    [InlineData(nameof(StockTransfersController.Start))]
    [InlineData(nameof(StockTransfersController.Complete))]
    [InlineData(nameof(StockTransfersController.Cancel))]
    ...
    [InlineData(nameof(StockTransfersController.GetAll))]
    [InlineData(nameof(StockTransfersController.GetById))]
    [InlineData(nameof(StockTransfersController.Create))]
    [InlineData(nameof(StockTransfersController.Start))]
    [InlineData(nameof(StockTransfersController.Complete))]
    [InlineData(nameof(StockTransfersController.Cancel))]
