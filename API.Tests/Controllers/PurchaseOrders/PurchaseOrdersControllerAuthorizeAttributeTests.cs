...
/// <summary>
/// PurchaseOrdersController yetkilendirme attribute'ları (reflection).
...
/// </summary>
public class PurchaseOrdersControllerAuthorizeAttributeTests
{
    ...
    {
        var authorize = typeof(PurchaseOrdersController).GetCustomAttribute<AuthorizeAttribute>(inherit: true);
    ...
    [Theory]
    [InlineData(nameof(PurchaseOrdersController.GetAll))]
    [InlineData(nameof(PurchaseOrdersController.GetById))]
    [InlineData(nameof(PurchaseOrdersController.GetByCompany))]
    public void ReadActions_AuthorizeRolesAll(string methodName)
    {
        var method = typeof(PurchaseOrdersController).GetMethod(methodName);
    ...
    {
        var method = typeof(PurchaseOrdersController).GetMethod(nameof(PurchaseOrdersController.Create));
        method.Should().NotBeNull();
    ...
    /// <summary>Approve / Receive / Cancel: Writers; Staff hariç.</summary>
    [Theory]
    [InlineData(nameof(PurchaseOrdersController.Approve))]
    [InlineData(nameof(PurchaseOrdersController.Receive))]
    [InlineData(nameof(PurchaseOrdersController.Cancel))]
    public void WriteLifecycleActions_AuthorizeRolesWriters(string methodName)
    {
        var method = typeof(PurchaseOrdersController).GetMethod(methodName);
        method.Should().NotBeNull();
    ...
    [InlineData(nameof(PurchaseOrdersController.GetById))]
    [InlineData(nameof(PurchaseOrdersController.GetByCompany))]
    [InlineData(nameof(PurchaseOrdersController.Create))]
    [InlineData(nameof(PurchaseOrdersController.Approve))]
    [InlineData(nameof(PurchaseOrdersController.Receive))]
    [InlineData(nameof(PurchaseOrdersController.Cancel))]
